...
try:
    ...
    test_question('What is the size of a planet?', '0.379 R<sub>♃</sub>.')
    test_question('What is the size of a planetary system?', '12.917 AU.')
    ...
    test_question('How many planets are there?', '4309.')
    test_question('How many exoplanets are there?', '4301.')
