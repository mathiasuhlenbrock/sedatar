...
try:
    ...
    test_question('What is the size of a planetary system?', '16.083 AU')
    ...
    test_question('What is the biggest planetary system?', 'COCONUTS-2 A')
    test_question('What is the smallest planetary system?', 'PSR J1719-1438')
    test_question('What is the closest gas giant?', 'Jupiter')
    test_question('What is the farthest gas giant?', 'HAT-P-63 b')
    ...
    test_question('How many planets are there?', '4533')
    test_question('How many exoplanets are there?', '4525')
